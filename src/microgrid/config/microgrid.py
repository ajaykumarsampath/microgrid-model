...
from microgrid.config.interface import IGridNetworkConfig, Reference, UnknownComponentConfigType
from microgrid.config.registry import IComponentRegistry
from microgrid.config.component.grid_forming_unit import ThermalGeneratorConfig, StoragePowerPlantConfig
