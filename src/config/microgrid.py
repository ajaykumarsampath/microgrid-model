...
from config.interface import IGridNetworkConfig, Reference, UnknownComponentConfigType
from config.registry import IComponentRegistry
from data_loader.microgrid_model import MicrogridModelDataLoader
from config.component.grid_forming_unit import ThermalGeneratorConfig, StoragePowerPlantConfig
from config.component.renewable_unit import RenewableUnitConfig
from config.component.load_demand import LoadDemandConfig
...
class MicrogridModelConfigBuilder:
    ...
    def add_unit_config_data(self, microgrid_config: MicrogridModelConfig,
    ...
    def generate_microgrid_model_data_loader(self, microgrid_config: MicrogridModelConfig) \
            -> MicrogridModelDataLoader:
    ...
    def generate_microgrid_config_from_data_loader(self, data_loader: MicrogridModelDataLoader) \
        ...
        data_ = {'name': grid.name, 'initial_timestamp': grid.get_initial_timestamp(),
